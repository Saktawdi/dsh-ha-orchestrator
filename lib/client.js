...
//   - `styles.insert(css)`       -> inline `<style data-plugin="ha-orchestrator">`
...
`
    if (typeof document !== 'undefined' && !document.querySelector('style[data-plugin="ha-orchestrator"]')) {
      const style = document.createElement('style')
      style.setAttribute('data-plugin', 'ha-orchestrator')
    ...
    const TYPERT_REMOTE = {
      package: 'ha-orchestrator',
      descriptors: [
        {
          id: 'ha-orchestrator#haOrchestrator/stateGet',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'stateGet',
          invocation: { kind: 'direct' },
          parameters: [],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#State', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/stateReload',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'stateReload',
          invocation: { kind: 'direct' },
        ...
        {
          id: 'ha-orchestrator#haOrchestrator/stateSet',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'stateSet',
          invocation: { kind: 'direct' },
          parameters: [
            { name: 'args', wire: 'args', source: 'json', codec: { mode: 'strict', typeSymbol: 'ha-orchestrator#StateSetArgs', schema: pass } },
          ],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#State', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/modelsList',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'modelsList',
          invocation: { kind: 'direct' },
          parameters: [
            { name: 'args', wire: 'args', source: 'json', codec: { mode: 'strict', typeSymbol: 'ha-orchestrator#ModelsListArgs', schema: pass } },
          ],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#ModelInfo[]', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/agentsGenerate',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'agentsGenerate',
          invocation: { kind: 'direct' },
          parameters: [
            { name: 'args', wire: 'args', source: 'json', codec: { mode: 'strict', typeSymbol: 'ha-orchestrator#AgentsGenerateArgs', schema: pass } },
          ],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#AgentsGenerateResult', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/haReset',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'haReset',
          invocation: { kind: 'direct' },
        ...
        {
          id: 'ha-orchestrator#haOrchestrator/haStatus',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'haStatus',
          invocation: { kind: 'direct' },
          parameters: [],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#HaStatus', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/haProbeNow',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'haProbeNow',
          invocation: { kind: 'direct' },
          parameters: [
            { name: 'args', wire: 'args', source: 'json', codec: { mode: 'strict', typeSymbol: 'ha-orchestrator#ProbeArgs', schema: pass } },
          ],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#ProbeResult', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/haSuggestBackups',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'haSuggestBackups',
          invocation: { kind: 'direct' },
          parameters: [],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#Suggestions', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/orchRuns',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'orchRuns',
          invocation: { kind: 'direct' },
          parameters: [],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#OrchRuns', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/orchListPresets',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'orchListPresets',
          invocation: { kind: 'direct' },
          parameters: [],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#Presets', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/orchSavePreset',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'orchSavePreset',
          invocation: { kind: 'direct' },
          parameters: [
            { name: 'args', wire: 'args', source: 'json', codec: { mode: 'strict', typeSymbol: 'ha-orchestrator#PresetArgs', schema: pass } },
          ],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#Presets', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/orchDeletePreset',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'orchDeletePreset',
          invocation: { kind: 'direct' },
          parameters: [
            { name: 'args', wire: 'args', source: 'json', codec: { mode: 'strict', typeSymbol: 'ha-orchestrator#DeletePresetArgs', schema: pass } },
          ],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#Presets', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/stateExport',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'stateExport',
          invocation: { kind: 'direct' },
          parameters: [],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#Export', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/stateImport',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'stateImport',
          invocation: { kind: 'direct' },
          parameters: [
            { name: 'args', wire: 'args', source: 'json', codec: { mode: 'strict', typeSymbol: 'ha-orchestrator#ImportArgs', schema: pass } },
          ],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#State', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/debugLogs',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'debugLogs',
          invocation: { kind: 'direct' },
          parameters: [],
          result: { mode: 'strict', typeSymbol: 'ha-orchestrator#DebugLogs', schema: pass },
        },
        {
          id: 'ha-orchestrator#haOrchestrator/debugClear',
          service: 'haOrchestrator',
          namespace: 'haOrchestrator',
          method: 'debugClear',
          invocation: { kind: 'direct' },
    ...
    function apply(ctx) {
      ...
      function HaCard(props) {
        ...
        return React.createElement(Card, {
          ...
          React.createElement('div', { className: 'hao-section' }, t('ha.runtime')),
          React.createElement(Row, { label: t('ha.currentDefault') },
            React.createElement('span', null, status.defaultSelection ? status.defaultSelection.provider + ' / ' + status.defaultSelection.model : t('common.unknown')),
          ),
          React.createElement('div', { className: 'hao-section' }, t('ha.quarantined', { n: (status.quarantine || []).length })),
          status.quarantine && status.quarantine.length > 0
            ? React.createElement('table', { className: 'hao-table' },
              React.createElement('thead', null, React.createElement('tr', null,
                React.createElement('th', null, t('ha.phProvider')), React.createElement('th', null, t('ha.phModel')), React.createElement('th', null, t('ha.thCode')), React.createElement('th', null, t('ha.thRemaining')),
              )),
          ...
          React.createElement(Row, { label: '' },
            React.createElement(Btn, { kind: 'danger', onClick: () => rpc.haReset().then((s) => props.setState(s)).catch(() => {}) }, t('ha.reset')),
          ),
        )
      }
      ...
      function registerSection() {
        ...
        sectionDispose = slots.inject('settings.section', () => slots.register(
          { name: 'settings.section', id: 'ha-orchestrator', order: 12, label: () => t('section.label') },
